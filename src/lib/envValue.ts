...
export const AUTH_GOOGLE_ID = z.string().parse(process.env.GOOGLE_AUTH_CLIENT_ID)
export const AUTH_GOOGLE_SECRET = z.string().parse(process.env.GOOGLE_AUTH_CLIENT_SECRET)
