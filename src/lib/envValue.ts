...
export const GOOGLE_AUTH_CLIENT_ID = z.string().parse(process.env.GOOGLE_AUTH_CLIENT_ID)
export const GOOGLE_AUTH_CLIENT_SECRET = z.string().parse(process.env.GOOGLE_AUTH_CLIENT_SECRET)
export const GOOGLE_AUTH_CALLBACK_URL = z.string().url().parse(process.env.GOOGLE_AUTH_CALLBACK_URL)
